...
import com.kiwihouse.mapper.ReportedInfoMapper;
 ...
 */
@Service
public class ReportedInfoService {
     ...
     * @return 上报信息
     */
    public ResultList queryInfo(ReportedQueryVo reportedQueryVo, UserInfo userInfo) {
        if (!userInfo.isAdmin()) {
