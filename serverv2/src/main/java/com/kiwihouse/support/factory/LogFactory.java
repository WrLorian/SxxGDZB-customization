...
public class LogFactory {
    ...
    public static AuthAccountLog createAccountLog(Integer userId,String logName, String ip, Short succeed, String message) {
    ...
    public static AuthOperationLog createOperationLog(Integer userId,String logName,String api, String method, Short succeed, String message) {
