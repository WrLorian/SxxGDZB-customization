package com.kiwihouse.support.factory;
...
public class LogTaskFactory {
    ...
    public static TimerTask loginLog(Integer userId, String ip, Short succeed, String message) {
    ...
    public static TimerTask exitLog(Integer userId, String ip, Short succeed, String message) {
        return new TimerTask() {
            @Override
            public void run() {
                try {
    ...
    public static TimerTask registerLog(Integer userId, String ip, Short succeed, String message) {
        return new TimerTask() {
            @Override
            public void run() {
                try {
    ...
    public static TimerTask bussinssLog(Integer userId, String api, String method, Short succeed, String message) {
        return new TimerTask() {
            @Override
            public void run() {
                try {
    ...
    public static TimerTask exceptionLog(Integer userId, String api, String method, Short succeed, String message) {
        return new TimerTask() {
            @Override
            public void run() {
                try {
